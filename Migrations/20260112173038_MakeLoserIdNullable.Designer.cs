...
namespace Blackjack.Migrations
{
    ...
    [Migration("20260112173038_MakeLoserIdNullable")]
    partial class MakeLoserIdNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blackjack.Models.PlayerHand", b =>
                {
                    b.HasOne("Blackjack.Models.Player", null)
                        .WithMany("PlayerHands")
                        .HasForeignKey("PlayerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Blackjack.Models.Round", null)
                        .WithMany("PlayerHands")
